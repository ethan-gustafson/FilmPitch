...
module ApplicationCable
  class Connection < ActionCable::Connection::Base
    ...
    # You can find the reject_unauthorized_connection method here -> 
    #   https://github.com/rails/rails/blob/master/actioncable/lib/action_cable/connection/authorization.rb
